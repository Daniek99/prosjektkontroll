...
export default function TodoList() {
    ...
    const renderTaskItem = (task: Task) => (
        <div
            ...
            onClick={(e) => {
                // Prevent opening panel if clicking a button/input
        ...
        >
            <div className="flex items-center flex-1 min-w-0">
                ...
                <button
                    ...
                    className="flex-shrink-0 mr-3 text-slate-400 hover:text-primary-600 transition-colors"
                >
                    {task.is_completed ? (
                ...
                <div className="flex flex-col flex-1 min-w-0">
                    {editingId === task.id ? (
                        <input
                            ...
                            className="bg-white border border-slate-300 rounded px-2 py-1 text-sm font-medium focus:outline-none focus:border-primary-500 w-full"
                        />
                    ) : (
                        <div
                            onClick={(e) => {
                    ...
                    {(task.description || task.due_date) && !task.is_completed && (
                        <div className="flex items-center space-x-2 mt-1">
                            {task.due_date && (
                                <div className={`flex items-center text-[10px] font-bold ${new Date(task.due_date) < new Date(new Date().setHours(0, 0, 0, 0)) ? 'text-red-500' : 'text-primary-600'}`}>
    ...
    return (
        <div className="bg-white border border-slate-200/60 rounded-3xl p-6 shadow-sm flex flex-col h-[400px]">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-slate-800">Mine Oppgaver</h2>
                        <p className="text-sm font-medium text-slate-500">Personlig to-do liste</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleAddTask} className="mb-4 relative">
                <input
                    ...
                    className="w-full pl-4 pr-12 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-all"
                />
                <button
                    type="submit"
            ...
            <div className="flex bg-slate-100 rounded-lg p-1 mb-4 flex-shrink-0">
                <button
                    ...
                    className={`flex-1 text-xs font-bold py-2 rounded-md transition-all ${activeTab === 'idag' ? 'bg-white shadow text-primary-600' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-200/50'}`}
                >
                ...
                <button
                    ...
                    className={`flex-1 text-xs font-bold py-2 rounded-md transition-all ${activeTab === 'imorgen' ? 'bg-white shadow text-primary-600' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-200/50'}`}
                >
                ...
                <button
                    ...
                    className={`flex-1 text-xs font-bold py-2 rounded-md transition-all ${activeTab === 'senere' ? 'bg-white shadow text-primary-600' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-200/50'}`}
                >
                    ...
                    <div className="flex-1 overflow-y-auto p-5 space-y-6">
                        ...
                        <div className="space-y-4 pl-9">
                            ...
                            <div className="flex items-start group">
                                <AlignLeft className="w-5 h-5 text-slate-400 mr-3 mt-1 group-hover:text-primary-500 transition-colors" />
                                <textarea
